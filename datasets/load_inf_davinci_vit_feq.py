...
class load_valset(Dataset):
    def __init__(self, file_paths, clip_len=4, sampling_len=10):
        ...
        self.list_raw = sorted(os.listdir(os.path.join(file_paths, 'image_0')))
    ...
    def __getitem__(self, idx):
        ...
        for c in clipIdx:
            ...
            # imgL = cv2.resize(imgL,(384//2, 192//2), interpolation=cv2.INTER_AREA)
            # imgR = cv2.resize(imgR,(384//2, 192//2), interpolation=cv2.INTER_AREA)
